...
const ProjectSidebar = ({ selectedProject, onProjectSelect, onNavigationChange, projects, setProjects, onCreateProject, mobileOpen, onMobileClose }) => {
  ...
  // New collapse state to make sidebar minimal
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            ...
            <Box>
              ...
              <IconButton
                ...
                sx={{ transform: projectsOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}
              >
        ...
        <Box sx={{ mb: 3 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            ...
            <IconButton
              ...
              aria-label={teamOpen ? 'Collapse team members' : 'Expand team members'}
              sx={{ transform: teamOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s' }}
            >
              <ExpandMoreIcon fontSize="small" />
            </IconButton>
          </Box>
